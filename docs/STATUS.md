...
## Now
- None (work block complete, about to commit v1.14)
...
## Next
1. Merge prelive → main via PR; tag v1.14 release so remote machines' one-line installs pick up worklog v1.14
