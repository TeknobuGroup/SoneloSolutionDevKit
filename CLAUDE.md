...
<!-- sonelo-devkit:uat:start v4.14 (managed by repo_setup.py; edit outside these markers) -->
## Writing UAT
...
cases — see "Fixing what a tester found" below.
    ...
    project:    teknobu-kit          (omit if UAT_HUB_PROJECT is set for this repo)
...
After pushing, read the same module back and compare the count:
    ...
    read_uat_test_cases  project: teknobu-kit, module: <the module you just pushed>
...
- This repo pushes to the UAT Hub project `teknobu-kit`. A push cannot create a project: if the
...
<!-- sonelo-devkit:start v4.14 (managed by repo_setup.py; edit outside these markers) -->
## Sonelo standards
